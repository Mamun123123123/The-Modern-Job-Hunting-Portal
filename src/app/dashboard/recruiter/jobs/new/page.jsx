...
export default function PostJobPage() {
    ...
    return (
        <div className="min-h-screen bg-[#a4a4ae] text-white py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-[#6f6f72] border border-zinc-900 rounded-xl p-8 shadow-2xl">
